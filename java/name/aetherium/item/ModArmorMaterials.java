...
import name.aetherium.AetheriumDataGenerator;
...
public enum ModArmorMaterials implements ArmorMaterial {
    AETHERIUM("aetherium", 42, new int[] {4, 9, 7, 4}, 20,
            SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 4, 0.15f, () -> Ingredient.ofItems(ModItems.AETHERIUM_INGOT));
    ...
    public String getName() {
        return Aetherium.MOD_ID + ":" + this.name;
    }
